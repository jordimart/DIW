 ...
 * current UA and makes the results available to you in two ways: as properties
 * on
...
(function(window, document, undefined) {
  ...
  // Fake some of Object.create so we can force non test results to be non "own"
  // properties.
          ...
          if (featureNameSplit.length === 1) {
            ...
            if (Modernizr[featureNameSplit[0]] &&
              ...
              Modernizr[featureNameSplit[0]] =
                new Boolean(Modernizr[featureNameSplit[0]]);
            }
  ...
  /**
   * createElement is a convenience wrapper around document.createElement. Since
   * we
   * use createElement all over the place, this allows for (slightly) smaller
   * code
   * as well as abstracting away issues with creating elements in contexts other
   * than
  ...
  function createElement() {
    if (typeof document.createElement !== 'function') {
      ...
      return document.createElementNS.call(
        document, 'http://www.w3.org/2000/svg', arguments[0]);
    } else {
